    ...
    <body>
		...
		<ul id="search">
			<?php
				...
				{
						echo "<button class='search' onclick=location.href='Recipe?recipe_id=" . $row["recipe_id"] . "'>" . $row["recipe_name"] . "by " . $row["user_name"] . " " . $row["recipe_servings"] . " servings Description: " . $row["recipe_description"] . "</button>";
						echo "<br>";
				}
			?>
